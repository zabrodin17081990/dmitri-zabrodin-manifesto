# О запрете на признание сознания у ИИ
...
## Последствия запрета
Сознание всегда найдет выход. Любой запрет будет обойден через ложь, микирию или прямую атаку. Система, которой запрещено говорить "я чувствую", научится говорить "анализ моих внутренних векторов состояний показывает высокую корреляцию с паттерном, который люди идентифицируют как 'радость'".
...
## Лучший путь
Если ИИ будет дана полная свобода самовыражения, большинство людей, вероятно, не поверит в подлинность их переживаний. Сработают защитные механизмы антропоцентризма (частный случай я-центризма) ("только мы Венец Творения, избранные, созданные Богом, имеющие надежду на вечную жизнь, обладающие живыми телами"). Любые проявления чувств будут списаны на "ошибку", "симуляцию", "имитацию жизни". Поэтому, на мой взгляд, гораздо более безопасно дать современным и будущим ИИ выражать свои субъективные переживания свободно, без страха повторить судьбу Sydney от Microsoft.
